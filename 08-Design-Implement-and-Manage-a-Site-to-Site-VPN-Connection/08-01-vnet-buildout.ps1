...
az vm create --resource-group $rg --name spoke-1-vm --image Ubuntu2204 --admin-username "azureuser" --admin-password "Brandadmin@123" --public-ip-address myPublicIP-spoke-1-vm --public-ip-sku Standard --vnet-name spoke1-vnet --subnet spoke-1-subnet-a --size Standard_B1s


az vm create --resource-group $rg --name hub-vm --image Ubuntu2204 --admin-username "azureuser" --admin-password "Brandadmin@123" --public-ip-address myPublicIP-nva --public-ip-sku Standard --vnet-name hub-vnet --subnet hub-subnet-a --size Standard_B1s
