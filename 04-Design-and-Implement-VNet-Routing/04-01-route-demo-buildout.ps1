...
az vm create --resource-group $rg --name vm-nva --image Ubuntu2204 --generate-ssh-keys --public-ip-address myPublicIP-nva --public-ip-sku Standard --vnet-name brand-hub-vnet --subnet nva-subnet --size Standard_B1s
