...
az vm create --resource-group $rg --location $location --name brand-hub-vm-01 --image Ubuntu2204 --admin-username azureuser --generate-ssh-keys --user-data ./cloud-init.txt --public-ip-address brand-hub-pip-01 --public-ip-sku Standard --vnet-name brand-hub-vnet --subnet hub-subnet-01 --nsg brand-hub-nsg-01 --size Standard_B1s --no-wait

# Create vm-2 in main hub vnet subnet-01
az vm create --resource-group $rg --location $location --name brand-hub-vm-02 --image Ubuntu2204 --admin-username azureuser --generate-ssh-keys --user-data ./cloud-init.txt --public-ip-address brand-hub-pip-02 --public-ip-sku Standard --vnet-name brand-hub-vnet --subnet hub-subnet-01 --nsg brand-hub-nsg-01 --size Standard_B1s --no-wait
...
az vm create --resource-group $rg --location $location --name brand-spoke1-vm-01 --image Ubuntu2204 --admin-username azureuser --generate-ssh-keys --user-data ./cloud-init.txt --public-ip-address brand-spoke1-pip-01 --public-ip-sku Standard --vnet-name brand-spoke1-vnet --subnet spoke1-subnet-01 --nsg brand-spoke1-nsg-01 --size Standard_B1s --no-wait

# Create vm-2 in spoke 1 vnet subnet-01
az vm create --resource-group $rg --location $location --name brand-spoke1-vm-02 --image Ubuntu2204 --admin-username azureuser --generate-ssh-keys --user-data ./cloud-init.txt --public-ip-address brand-spoke1-pip-02 --public-ip-sku Standard --vnet-name brand-spoke1-vnet --subnet spoke1-subnet-01 --nsg brand-spoke1-nsg-01 --size Standard_B1s --no-wait
...
az vm create --resource-group $rg --location $location --name brand-spoke2-vm-01 --image Ubuntu2204 --admin-username azureuser --generate-ssh-keys --user-data ./cloud-init.txt --public-ip-address brand-spoke2-pip-01 --public-ip-sku Standard --vnet-name brand-spoke2-vnet --subnet spoke2-subnet-01 --nsg brand-spoke2-nsg-01 --size Standard_B1s --no-wait

# Create vm-2 in spoke 2 vnet subnet-01
az vm create --resource-group $rg --location $location --name brand-spoke2-vm-02 --image Ubuntu2204 --admin-username azureuser --generate-ssh-keys --user-data ./cloud-init.txt --public-ip-address brand-spoke2-pip-02 --public-ip-sku Standard --vnet-name brand-spoke2-vnet --subnet spoke2-subnet-01 --nsg brand-spoke2-nsg-01 --size Standard_B1s --no-wait
